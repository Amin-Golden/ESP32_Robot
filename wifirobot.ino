...
const char* ssid ="MarsRover" ;// "AMAX"
const char* password = "mars2023" ;//;""
  ...
  <body>
      <div class="row">
        <div class="col"  style = "max-width: 250px ;height:600px ;  background-color: #34363d; border: 2px dashed #15da71;">
          <h1 style = "font-size: 15px; background-color: #ffffff; border: 2px dashed #15da71;">Camera Controll</h1>
          <div class="slidecontainer" >

          <p style = "color: white; position:relative; left:0px; top:10px;">Pan: <span id="panV"></span></p>
          <!-- <p style = "position:relative; left:-100px; top:20px;">pan</p> -->
          <input type="range" min="1" max="180" value="90" class="slider" id="pan" style = "transform: rotate(270deg);position:relative; left:0px; top:120px;">
          </div>
          <div class="slidecontainer" >
          ...
          <p style = "color: white; position:relative; left:0px; top:200px;">Tilt: <span id="tiltV"></span></p>
          </div>
  
        </div>
        <div class="col"  style = "height:600px ;  background-color: #4281b8; border: 2px dashed #15da71;">
          <h1 style = "font-size: 15px; position:relative; left:center ; top:-30px; background-color: #ffffff; border: 2px dashed #8e1237;">Camera </h1>

          <img src="" id="photo" > 

        </div>
        <div class="col"  style = "max-width: 250px ;height:600px ;  background-color: #34363d; border: 2px dashed #15da71;">
          <h1 style = "font-size: 15px; background-color: #ffffff; border: 2px dashed #15da71;">Robot Joystick</h1>
